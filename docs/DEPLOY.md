...
| Lane E.2 effectiveness/tuning | `ref_effectiveness_policy` · `gold_rule_effectiveness` · `gold_rule_recommendations` (AI proposals, HITL, versioned rules) |
...
| Lane E notebooks | `00c_lane_e_setup` · `00d_source_feed_simulation` · `01d_wageroll_extraction` · `05d_lane_e_crux` · `03c_gold_referral_events` · `02d_referral_conformance` (DLT) · `07b_rule_effectiveness` · `07c_rule_tuning_agent` · `08_metric_views` · `09_external_agent_governed_call` |
